...
namespace Raven.Smuggler
{
    public class Program
    {
        ...
        private void DefineDatabaseOptionsSet(SmugglerDatabaseOptions databaseOptions)
        {
            ...
            databaseOptionSet.Add("split-outfile-size:", OptionCategory.SmugglerDatabase, "Spin split exported filesize in MB", s => databaseOptions.SplitOutfileSize = int.Parse(s));
            databaseOptionSet.Add("import-all-splitted-files", OptionCategory.SmugglerDatabase, "Import all splitted files", _ => databaseOptions.ImportAllSplittedFiles = true);
