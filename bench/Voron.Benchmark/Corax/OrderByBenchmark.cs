...
namespace Voron.Benchmark.Corax
{
    ...
    public class OrderByBenchmark
    {
        ...
        {            
            ...
            var query = _indexSearcher.OrderBy(ageTerm, new OrderMetadata(ageField, true, MatchCompareFieldType.Sequence), defaultNullsSortMode: NullsSortMode.NullsSmallest, take: TakeSize);
