...
{
    class RavenDB_4580 : RavenTestBase
    {

        [Fact]
        public void WhatChangedWithArrayAndObject()
        {
            ...
            using (var store = NewDocumentStore())
            {
                ...
                using (var session = store.OpenSession())
                {
                    ...
                    Assert.Equal(1, whatChanged.First(x => x.Key == carId).Value.Count(x => x.FieldName == "PreviousOwner.FirstName"));
                }
            }
        }
