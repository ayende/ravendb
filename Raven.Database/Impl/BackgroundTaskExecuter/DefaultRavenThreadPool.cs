// -----------------------------------------------------------------------
//  <copyright file="DefaultRavenThreadPool.cs" company="Hibernating Rhinos LTD">
...
{
    public class DefaultRavenThreadPool : RavenThreadPool
    {
        [ThreadStatic]
        ...
        public DefaultRavenThreadPool(int maxLevelOfParallelism, CancellationToken ct, DocumentDatabase database, string name = "RavenThreadPool", IReadOnlyList<Action> longRunningActions = null)
        {
        ...
        public override void ExecuteBatch<T>(IList<T> src, Action<IEnumerator<T>> action, 
        ...
        public override void ExecuteBatch<T>(IList<T> src, Action<T> action, string description = null,
