...
namespace Raven.Abstractions.Util
{
	...
	public class SerializedAsyncContext
	{
		...
		private SerializedAsyncContext()
		{
		...
		{
			var instance = new SerializedAsyncContext();
		...
		{
			private readonly SerializedAsyncContext parent;
			public SerialSynchronizationContext(SerializedAsyncContext parent)
			{
				this.parent = parent;
			}
		...
		private class QueueTaskScheduler : TaskScheduler
		{
			...
			public QueueTaskScheduler(SerializedAsyncContext parent)
			{
				this.parent = parent;
			}
