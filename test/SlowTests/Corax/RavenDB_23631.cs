...
public class RavenDB_23631(ITestOutputHelper output) : StorageTest(output)
{
    ...
    private List<string> ExecuteRQLQuery(IndexFieldsMapping mapping, string rqlQuery)
    {
        ...
        var match = QueryPlanBuilder.BuildFilterMatch(planParams, new QueryBuilderParameters(searcher, Allocator, queryMetadata, null, mapping), out _, out _, null, false, default);
