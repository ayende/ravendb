...
public class RankingFunctionTests : StorageTest
{
    ...
    private List<string> ExecuteRQLQueryByScore(string rqlQuery)
    {
        ...
        var match = QueryPlanBuilder.BuildFilterMatch(planParams, new QueryBuilderParameters(searcher, Allocator, queryMetadata, null, _mapping, hasBoost: true), out _, out _, null, false, default);
