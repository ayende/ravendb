...
namespace Raven.Client.Connection
{
	...
	public class HttpJsonRequestFactory : IDisposable
	{
		...
		public HttpJsonRequest CreateHttpJsonRequest(CreateHttpJsonRequestParams createHttpJsonRequestParams)
		{
			...
			ConfigureRequest(createHttpJsonRequestParams.Owner, new WebRequestEventArgs {Client = HttpJsonRequest.httpClient, Credentials = createHttpJsonRequestParams.Credentials});
			return request;
		}
