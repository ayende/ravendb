...
#pragma warning restore RDB0008
        ...
        // B+tree traversal creates a TreePage wrapper per page visit. The wrappers never escape
        // their transaction (cursors and the recently-found-pages cache are transaction scoped),
        // so they come from an arena that is returned to the persistent context on dispose.
