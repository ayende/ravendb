...
internal sealed unsafe class JournalWritePipeline : IDisposable
{
    ...
    internal const int MaxPipelinedBatch4Kbs = MaxPipelinedBatchSizeInBytes / Constants.Storage.JournalPageSize;
    ...
    // whether pipelining SHOULD be used right now is the WriteFlowPolicy's call - this class
    // only provides the mechanics (slots, buffers, submission)
    internal bool HasInFlightWrites =>
