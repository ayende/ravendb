...
namespace Voron.Impl.Journal
{
    ...
    public sealed unsafe class WriteAheadJournal : IDisposable
    {
        ...
        public record PendingJournalStateRecord(
            ...
            Pal.journal_entry Entry)
        {
            public JournalStateRecord JournalStateRecord => new JournalStateRecord(Transaction, Tcs, Consumed, Entry);
        }
        ...
        public sealed class JournalApplicator : IDisposable
        {
            ...
            public sealed class SyncOperation(WriteAheadJournal.JournalApplicator parent) : IDisposable
            {
                ...
                private void CallPagerSync()
                {
                    ...
                    // The coming sync will cover all the dirty pages, so we can reset the dirty tracking to avoid double counting.
...
#pragma warning restore RDB0008
                        var pendingJournalStateRecord = new PendingJournalStateRecord(tx, branchCommit, consumed, entry);
