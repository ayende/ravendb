...
namespace Voron.Impl.Journal
{
    ...
    public sealed class DeviceWriteBudget
    {
        ...
        private Sparrow.Utils.SimpleEwma<long> _syncCostTicksEwma = new(smoothing: 4);
        private Sparrow.Utils.SimpleEwma<double> _queueDepth = new(smoothing: 4);
        ...
        private Sparrow.Utils.SimpleEwma<long> _journalWriteLatencyTicks = new(smoothing: 8);
        private Sparrow.Utils.SimpleEwma<long> _journalWriteSizeBytes = new(smoothing: 8);
