...
internal static class SortKernels
{
        ...
        long nonExistingTermContainerId)
    {
        ...
        if (lookup != null)
        {
            ...
            Container.GetAllSortedByPage(llt, termIdsScratch.Slice(0, n), termsOut.Slice(0, n), pageLocator);
        }
        else
        {
        ...
        long nonExistingTermContainerId)
    {
        ...
        if (lookup != null)
        {
            ...
            SortingHelpers.ReplaceNullAndNonExistingTermIds(
                termIdsScratch.Slice(0, n), nonExistingTermContainerId, nullTermContainerId, SortingHelpers.MissingTermId);
            Container.GetAllSortedByPage(llt, termIdsScratch.Slice(0, n), termsScratch.Slice(0, n), pageLocator);
        }
        else
        {
