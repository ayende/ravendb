...
if ($clang_only) {
    ...
    cmd /c """$vcbin\vcvars64.bat"" & ""$clbin\x64\cl"" /Fdruntimes/win-x64/native/librvnpal.pdb /Zi -Feruntimes/win-x64/native/librvnpal.dll -I inc /O2 /LD $shared $win_files /link"
    Remove-Item *.obj
    Remove-Item  librvnpal.x*
    Remove-Item *.nativecodeanalysis.xml
}

cp runtimes/win-x64/native/librvnpal.* C:\Work\ravendb-7.0\test\RachisTests\bin\Release\net9.0\runtimes\win-x64\native
