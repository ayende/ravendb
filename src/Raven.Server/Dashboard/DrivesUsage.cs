...
namespace Raven.Server.Dashboard
{
    public class DrivesUsage : AbstractDashboardNotification
    {
        ...
        public override DynamicJsonValue ToJsonWithFilter(Func<string, bool, bool> filter)
        {
    ...
    public class MountPointUsage : IDynamicJson
    {
        ...
        public DynamicJsonValue ToJsonWithFilter(Func<string, bool, bool> filter)
        {
            var json = ToJsonInternal();
            ...
            {
                if (filter(databaseDiskUsage.Database, false))
                {
