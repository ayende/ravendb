...
namespace Raven.Server.Web.System
{
    ...
    {
        [RavenAction("/admin/monitoring/v1/server", "GET", AuthorizationStatus.Operator, EndpointType.Read)]
        ...
        [RavenAction("/admin/monitoring/v1/databases", "GET", AuthorizationStatus.Operator, EndpointType.Read)]
        ...
        [RavenAction("/admin/monitoring/v1/indexes", "GET", AuthorizationStatus.Operator, EndpointType.Read)]
        ...
        [RavenAction("/admin/monitoring/v1/collections", "GET", AuthorizationStatus.Operator, EndpointType.Read)]
