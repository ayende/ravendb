...
namespace Raven.Server.Documents.Indexes.Persistence.Lucene
{
    public class LuceneIndexPersistence : IDisposable
    {
        ...
        public IndexWriteOperation OpenIndexWriter(Transaction writeTransaction)
        {
            ...
            return new IndexWriteOperation(_index.Definition.Name, _index.Definition.MapFields, _directory, _converter, writeTransaction, this, _index._indexStorage.DocumentDatabase.LoggerSetup); // TODO arek - 'this' :/
        }
        ...
        public IndexReadOperation OpenIndexReader(Transaction readTransaction)
        {
            ...
            return new IndexReadOperation(_index.Definition.Name, _index.Type, _index.MaxNumberOfIndexOutputs, _index.ActualMaxNumberOfIndexOutputs, _index.Definition.MapFields, _directory, _indexSearcherHolder, readTransaction, _index._indexStorage.DocumentDatabase.LoggerSetup);
        }
        ...
        internal LuceneIndexWriter EnsureIndexWriter()
        {
            ...
            try
            {
                ...
                return _indexWriter = new LuceneIndexWriter(_directory, StopAnalyzer, _snapshotter, 
                    IndexWriter.MaxFieldLength.UNLIMITED, null, _index._indexStorage.DocumentDatabase.LoggerSetup);
            }
            catch (Exception e)
            {
